    ...
    <div class="container-fluid" style="padding-top: 3rem; padding-bottom: 6rem; padding-left: 10px; padding-right: 20px">
        <div class="form-row justify-content-center">
            <div class="col-md-12">
                <div class="form-row">
                    <div class="col-md-8">
                        <h4 class="card-title">Enviar documentação do requerimento requerida
                        </h4>
                                    ...
                                    <div class="card-body bg-white">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4" style="text-align: left;">
                                                @switch($requerimento->documentos_analista()->where('documento_id', $documento->id)->first()->pivot->status)
                                                    @case($status['aceito'])
                                        ...
                                        <div class="form-group">
                                            @switch($requerimento->documentos_analista()->where('documento_id', $documento->id)->first()->pivot->status)
                                                        ...
                                                        @if($requerimento->documentos()->where('documento_id', $documento->id)->first()->pivot->comentario != null)
                                                            <div class="card card-doc-aceito mb-3">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <strong>Comentário: </strong>{{$requerimento->documentos_analista()->where('documento_id', $documento->id)->first()->pivot->comentario}}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                @case($status['recusado'])
                                                    <div class="row justify-content-center" style="padding-top: 1rem;">
                                                        @if($requerimento->documentos_analista()->where('documento_id', $documento->id)->first()->pivot->comentario != null)
                                                            <div class="card card-doc-recusado">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <strong>Motivo: </strong>{{$requerimento->documentos_analista()->where('documento_id', $documento->id)->first()->pivot->comentario}}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
